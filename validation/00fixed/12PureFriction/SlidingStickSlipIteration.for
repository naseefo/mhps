...
C	  WRITE(*,*) FAB(1)
        FAB(2)=CY1*VY2(NST) + AKY1*DY2(NST) 
...
C       WRITE(*,1316)K,TIME,ID,(FAB(I),I=1,2)
        FAB1 = 0.0
        DO 2424 KK = 1,NST
        FAB1 = FAB1 - SMX(KK,KK)*AAX(KK)
2424    CONTINUE
        WRITE(4,1346)TIME,AAX(1),AAY(1),DX2(NDOF),DY2(NDOF),FAB,FAB1
 ...
 1020   CONTINUE
        ...
        WRITE(5,1356) IJK,PRES(1),PRES(2)
C        WRITE(5,1356) IJK,PAX(1),PAY(1),PDX(NDOF),PDY(NDOF)
        WRITE(3,1350)
        DO 152 I=1,NDOF
