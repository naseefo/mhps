...
C RV114.FOR..............................................31/12/99
        ...
        DIMENSION SK6(6,6),SM6(6,6),CD6(6,6),SMI(6,6)
        DIMENSION TD(6),TV(6),TA(6),FAB(3)
...
c        WRITE(4,1354) TIME,A2(1)/10.0,D2(4)*100.0,D27*100.0
...
c       WRITE(10,1354) BS(1),BS(2),BS(3),BS(4),BS(5),BS(6)
 ...
 155    CONTINUE
        PD(I)=PD(I)/NR
 156    CONTINUE
c        WRITE(5,1387) PA(1)/10.0,PD(4)*100.0,PD27*100.0
        WRITE(5,1387) PD(4)*100.0,PD(5)*100.0,PD(6)*100.0,PD27*100.0
c       WRITE(5,1356) IJK,(PA(I)/10.0,I=1,6)
c       WRITE(5,1356) IJK,(PD(I)*100.0,I=1,6)
 1050   CONTINUE
        YC=0.5*SQRT(25.0+25.0)+EBX*SIN(45.0)
        FACT=(1+YC*(12.0*EBX/(2.0*25.0)))
        DTM=ABS(PD(4))*FACT	   
        WRITE(3,*)DTM*100.0,PD27*100.0
