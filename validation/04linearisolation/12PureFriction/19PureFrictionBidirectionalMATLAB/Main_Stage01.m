%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%            Program to find response of liner-viscous base-isolated  % 
%                           shear type building                       %       
%                                                                     %
%                                                                     %
%                                                                     %
...
dt_o=0.02; % Time step in seconds
...
figure(5)
subplot(3,1,1)
plot(t,1*Floor_acc(1,:)./9.81,t,xg./9.81)
axis([0 30 -1 1])
title('Top floor absolute acceleration (g)')
subplot(3,1,2)
plot(t,xg./9.81)
axis([0 30 -1 1])
