    ...
    for i in range(1, len(xg)):
        ...
        if sliding_state == False:
            ...
            for ii in range (nit):
                ...
                #     print("Velocity in resultant : %15.12f m/s | vx2: %15.12f m/s | vy2: %15.12f m/s "%(rvl, vx2[ndof-1, 0], vy2[ndof-1, 0]))
                ...
                if rvl > 1.0e-5:
                    ...
                    qx2 = qx
                    qy2 = qy
                    dfabx = qx2*vx2[ndof-1,0]/rvl - fabx
                    dfaby = qy2*vy2[ndof-1,0]/rvl - faby
            ...
            #     print("PF: Slide at t : %8.4f s | fabx = % 8.4f N | faby = % 8.4f N | ddx: % 8.4f m | ddx: % 8.4f m  "%(t, fabx, faby, ddx[ndof-1], ddy[ndof-1]))
            #     print("PF: Slide at t : %8.4f s | qx = % 8.4f N | qy = % 8.4f N | ddx: % 8.4f m | ddy: % 8.4f m  "%(t, qx2, qy2, ddx[ndof-1], ddy[ndof-1]))
        ...
        if not i%(ndiv):
            ...
            fx[index, ndof-1] = fabx + skx[ndof-1, ndof-1]*dx2[ndof-1,0]
            fy[index, ndof-1] = faby + sky[ndof-1, ndof-1]*dy2[ndof-1,0]
            ek[index, 0] = eki
            ed[index, 0] = edi
            es[index, 0] = esi
            ei[index, 0] = eii
