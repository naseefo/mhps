...
def simulator_boucwen(ref, xg, yg, dt, ndiv, ndt, lxy, ijk, ndof, smx, skx, cdx, smy, sky, cdy, iso, screen_on):
    ...
    print("ALPX")
    print("%20.16f %20.16f %20.16f %20.16f"%(iso.g1, skx[ndof-1, ndof-1], iso.f0, tm))
    ...
    for i in range(1,len(xg)):
        ...
        # if i%ndiv == 0:
        #     print("time: %8.6f s | fyx in X : %18.12f | fyy: %18.12f | alp: %18.12f"%(t, fyx, fyy, alpx)) 
        #     print("time: %8.6f s | dpz in X : %18.12f | Y: %18.12f"%(t, dpzx, dpzy))
